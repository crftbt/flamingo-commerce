...
//go:generate go run github.com/vektra/mockery/v2@v2.42.1 --name GiftCardHandler --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.42.1 --name VoucherHandler --case snake
