...
//go:generate go run github.com/vektra/mockery/v2@v2.42.1 --name CompleteBehaviour --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.42.1 --name CustomerCartService --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.42.1 --name GiftCardAndVoucherBehaviour --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.42.1 --name GiftCardBehaviour --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.42.1 --name GuestCartService --case snake
//go:generate go run github.com/vektra/mockery/v2@v2.42.1 --name ModifyBehaviour --case snake
